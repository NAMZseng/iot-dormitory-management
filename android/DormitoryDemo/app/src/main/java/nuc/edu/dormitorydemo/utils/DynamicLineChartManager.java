...
public class DynamicLineChartManager {
     ...
     * @param humitureInfo
     */
    public void addEntry(HumitureInfo humitureInfo) {
        ...
        Date date = new Date(humitureInfo.getCollectTime());
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

        timeList.add(sdf.format(date).substring(11));

        Entry entry = new Entry(lineDataSet.getEntryCount(), Float.valueOf(humitureInfo.getTemperature()+""));
        lineData.addEntry(entry, 0);
        lineData.notifyDataChanged();
        lineChart.notifyDataSetChanged();
        ...
        Entry entry1 = new Entry(lineDataSet.getEntryCount(), Float.valueOf(humitureInfo.getHumidity()+""));
